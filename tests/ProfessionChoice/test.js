module.exports = {
	...
	icon: 'prof_choice.jpg',
	shortDesc: "Этот тест предоставляет в обзорном виде множество профессиональных возможностей и посредством этого готовит к осознанному и обоснованному выбору профессии. ",
	longDesc: "В жизни большинства взрослых людей профессия играет важную роль. Профессия позволяет не только существовать в современных экономических условиях, но также дает возможность социальных контактов и часто является важным источником личностного саморазвития. Большое значение в профессиональной деятельности имеет выбор профессии, а следовательно и успешный жизненный выбор. Правильное решение должно быть тщательно обдуманно. Для этого необходимо, насколько возможно, изучить различные аспекты этого решения. Прежде всего, это касается молодых людей, которым предстоит сделать выбор в условиях общественно - образовательной системы. Именно профессиональное включение особенно значимо в процессе социальной интеграции.",
	...
	content: {
				...
				questions: [
					{
						...
						6: "хранить компьютерные диски",
						3: "заносить данные в компьютер"
					}, {
						1: "с точностью интерпретировать статистические данные",
						5: "устранять источники нарушений в технических системах",
						2: "консультировать клиентов при покупке компьютера"
					}
				]
			},
			{
				...
				questions: [
					{
						...
						4: "собирать отдельные детали в правильной последовательности",
		...
		interests: [{
				...
				color: "#993300",
				name: "проявлять заботу о покупателях, пациентах, клиентах"
			}
		],
		skills: [{
				color: "#993366",
